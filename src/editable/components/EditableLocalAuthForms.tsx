...
const inputClass = 'h-12 rounded-xl border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#1f241c] outline-none transition placeholder:text-[#72796c] focus:border-[#ff4a1f] focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-xl bg-[#ff4a1f] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
